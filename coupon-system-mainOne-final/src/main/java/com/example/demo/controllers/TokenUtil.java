...
@Service
	public class TokenUtil {
		...
		/**create the token with the user details 
		 * @param userDetails
		 * @return
		 */
		...
		private String createToken(Map<String, Object> claims, String email) {
			...
			return Jwts.builder().setClaims(claims)
					...
					.setExpiration(Date.from(now.plus(30, ChronoUnit.MINUTES))).signWith(this.decodedSecretKey)
		 ...
		 * @throws JwtException
		 */
		public int extractUserId(String token) throws JwtException {
		...
		public static class UserDetails {
			 ...
			 * @param clientType
			 */
			public UserDetails(int userid, String email, ClientType clientType) {
				super();
				this.userid = userid;
				this.email = email;
